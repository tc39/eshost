...
function sendStackParser(req, res) {
  res.writeHead(200, { 'Content-type': 'application/javascript' });
  res.end(
    fs.readFileSync(Path.join(__dirname, '../node_modules/error-stack-parser/node_modules/stackframe/dist/stackframe.js')) +
    fs.readFileSync(Path.join(__dirname, '../node_modules/error-stack-parser/dist/error-stack-parser.js'))
  );
}
