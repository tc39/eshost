...
class JavaScriptCoreAgent extends ConsoleAgent {
  static RUNTIME = fs.readFileSync(runtimePath.for("javascriptcore"), "utf8");
  ...
  constructor(...args) {
    ...
    */
    ...
    if (DYLD_FRAMEWORK_PATH === undefined) {
      if (isSymlinkSync(this.hostPath)) {
...
export default JavaScriptCoreAgent;
